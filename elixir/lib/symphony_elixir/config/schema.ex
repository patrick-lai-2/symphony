defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      field(:kind, :string)
      # Default endpoint targets the Linear GraphQL API; Jira (and other adapters)
      # supply their own base URL via WORKFLOW.md.
  ...
  defp finalize_settings(settings) do
    ...
    tracker = %{
      settings.tracker
      | endpoint: resolve_secret_setting(settings.tracker.endpoint, System.get_env("JIRA_ENDPOINT")),
